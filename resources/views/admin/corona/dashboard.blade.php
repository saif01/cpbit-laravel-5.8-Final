      ...
      <div class="card gradient-ibiza-sunset">
        <div class="card-content">
          <div class="card-body pt-2 pb-0">
            <div class="media">
              <div class="media-body white text-left">
                <h3 class="font-large-1 mb-0">{{ $todayTepmMeasured }}</h3>
                <span>Today User Measured</span>
              </div>
              <div class="media-right white text-right">
      ...
      <div class="card gradient-green-tea">
        <div class="card-content">
          <div class="card-body pt-2 pb-0">
            <div class="media">
              <div class="media-body white text-left">
                <h3 class="font-large-1 mb-0">{{ $todayOtherTepmMeasured }}</h3>
                <span>Today Others Measured</span>
              </div>
              <div class="media-right white text-right">
      ...
      <div class="card gradient-pomegranate">
        <div class="card-content">
          <div class="card-body pt-2 pb-0">
            <div class="media">
              <div class="media-body white text-left">
              <h3 class="font-large-1 mb-0">{{ $totalTepmRec }}</h3>
