...
<script>
    (function(){
        ...
        var chartData = {
        labels: [
        <?php foreach ($chartData as $level ){ echo '"' . $level->department . '"' . ','; } ?>
        ],
        datasets: [{
                ...
                <div class="card-body pt-2 pb-0">
                    <div class="media">
                        <div class="media-body white text-left">
                            <h3 class="font-large-1 mb-0">{{ $TotalRoomUser }}</h3>
                            <span>Total Room User</span>
                        </div>
        ...
        <div class="card gradient-green-tea">
            <div class="card-content">
                <div class="card-body pt-2 pb-0">
                    <div class="media">
                        <div class="media-body white text-left">
                            <h3 class="font-large-1 mb-0">{{ $TotalCanceled }}</h3>
    ...
    <div class="col-sm-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Room Booking Chart By Departments</h4>
            </div>
            <div class="card-content">
