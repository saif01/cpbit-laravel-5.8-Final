...
<script>
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#dataModalLabel').text('Group Add');

            $('#modalForm').prop('action', '{{ route("network.group.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#dataModalLabel').text('Group Edit');
            $('#id').val(id);
            $('.inputField').val(data);
            $('#modalForm').prop('action', '{{ route("network.group.update.action") }}');
            $('#dataModal').modal('show');
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Sub IP Group Name
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('network.group.delete',[$row->id]) }}" id="delete"
                                            class="btn gradient-ibiza-sunset white mr-1" title="Delete"> <i
                                                class="fa fa-trash"></i>: Delete</a>


                                        <button title="Edit" id="{{ $row->id }}" data="{{ $row->name }}"
            ...
            <div class="modal-body">
                <form action="" method="POST" id="modalForm">
                    ...
                    <div class="form-group">
                        <input type="text" name="name" id="checkValue" class="inputField form-control"
                            placeholder="Type Group Name" required="required">
