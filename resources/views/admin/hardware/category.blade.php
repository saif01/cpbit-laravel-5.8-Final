...
<script>
    $(function() {
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#dataModalLabel').text('Category Add');

            $('#modalForm').prop('action', '{{ route("hard.category.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#id').val(id);
            $('.inputField').val(data);
            $('#modalForm').prop('action', '{{ route("hard.category.update.action") }}');
            $('#dataModal').modal('show');
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Hardware Category Name
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('hard.category.delete',[$row->id]) }}" id="delete"
                                            class="btn text-danger" title="Delete"> <i
                                                class="fa fa-trash"></i>: Delete</a>


                                        <a href="javascript:void(0);" title="Edit" id="{{ $row->id }}" data="{{ $row->category }}"
            ...
            <div class="modal-body">
                <form action="" method="POST" id="modalForm">
                    ...
                    <div class="form-group">
                        <input type="text" name="category" id="checkValue" class="inputField form-control"
                            placeholder="Type Application Category Name" required="required">
