    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-colored-controls">New Product Edit</h4>

            </div>
            <div class="card-body">

                <form action="{{ route('inv.add.edit.action', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="serial" class="form-control" id="checkValue" placeholder="Enter Product Serial Number" value="{{ $data->serial }}"
                                    required="required">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <input type='text' class="form-control" id="datepicker" name="purchase" placeholder="Enter Purchase Date" value="{{ $data->purchase }}"
                                        required="required" />
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="custom-control custom-radio d-inline-block ml-2">
                                        <input type="radio" id="activeY" value="1" name="warr_st" class="custom-control-input" >
                                ...
                                @if ($data->warranty)
                                <span class="badge badge-primary">Yes</span>
                                {{ date("F j, Y", strtotime($data->warranty)) }}
                                @else
                                <span class="badge badge-danger">No</span>
                                @endif
                            </div>
