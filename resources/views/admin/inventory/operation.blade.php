...
<script>
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#dataModalLabel').text('Operations Add');

            $('#modalForm').prop('action', '{{ route("operation.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#dataModalLabel').text('Operations Edit');
            $('#id').val(id);
            $('.inputField').val(data);
            $('#modalForm').prop('action', '{{ route("operation.update.action") }}');
            $('#dataModal').modal('show');
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Operations Name
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('operation.delete',[$row->id]) }}" id="delete"
                                            class="btn gradient-ibiza-sunset white mr-1" title="Delete"> <i
                                                class="fa fa-trash"></i>: Delete</a>


                                        <button title="Edit" id="{{ $row->id }}" data="{{ $row->operation }}"
            ...
            <div class="modal-body">
                <form action="" method="POST" id="modalForm">
                    ...
                    <div class="form-group">
                        <input type="text" name="operation" id="checkValue" class="inputField form-control"
