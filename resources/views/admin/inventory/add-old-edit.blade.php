    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-colored-controls">Old Product Edit</h4>
            </div>
            <div class="card-body">

                <form action="{{ route('inv.edit.old.action', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="cat_id" id="hardCategory" >
                        ...
                        <div class="col-md-4">
                            ...
                            <select class="form-control" name="sub_id" id="hardSubCategory" >
                                <option value="">{{ $data->subcategory }}</option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="operation" required="required">
                                    ...
                                    <option value="{{ $operation->operation }}" @if ($operation->operation == $data->operation)
                                        selected @endif >{{ $operation->operation }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="bu_location" required="required">
                                    ...
                                    <option value="{{ $bulocation->bu_location }}" @if ($bulocation->bu_location == $data->bu_location)
                                        selected @endif >{{ $bulocation->bu_location }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="department" required="required">
                                        ...
                                        <option value="{{ $dept->dept_name }}" @if ($dept->dept_name == $data->department) selected @endif >{{ $dept->dept_name }}</option>
                                        @endforeach
                                    </select>
                                </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="type" required="required">
                                    <option value="Running" @if ($data->type == 'Running') selected @endif>Running Product</option>
                                    <option value="Damaged" @if ($data->type == 'Damaged') selected @endif>Damaged Product</option>
                                </select>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="serial" class="form-control" id="checkValue"
                                    placeholder="Enter Product Serial Number" required="required" value="{{ $data->serial }}" >
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label>Remarks</label>
                                <textarea class="form-control" name="remarks" required="required">{{ $data->remarks }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-actions right">
                        ...
                        <button id="btnSubmit" type="submit" name="submit" class="btn btn-raised btn-primary"><i class="fa fa-check-square-o"></i> Update</button>
                    </div>
