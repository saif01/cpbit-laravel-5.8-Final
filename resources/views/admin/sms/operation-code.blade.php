...
<script>
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#modalForm').prop('action', '{{ route("sms.admin.operation.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#modalForm').prop('action', '{{ route("sms.admin.operation.update.action") }}');
            $('#dataModal').modal('show');
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('sms.admin.operation.delete',[$row->id]) }}" id="delete"
