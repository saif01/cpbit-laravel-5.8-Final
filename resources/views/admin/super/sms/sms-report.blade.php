        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">SMS Information
                     
                    
                        <a href="{{ route('sms.export.excel',[ 'date'=>$date, 'code'=>$code]) }}">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        Thank you for CPB Product Order <span class="text-danger">{{ $sum_tot_Price}}</span> Tk. on {{ $value[0]->INVOICE_DATE }} <br>
