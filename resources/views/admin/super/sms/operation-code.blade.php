...
<script>
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#modalForm').prop('action', '{{ route("sms.operation.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#modalForm').prop('action', '{{ route("sms.operation.update.action") }}');
            $('#dataModal').modal('show');
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('sms.operation.delete',[$row->id]) }}" id="delete"
