            ...
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title text-capitalize">
                        ...
                        Car Booking Reports
                        <span
                            class="text-danger">{{ date("F j, Y", strtotime($searchData->start))." To ".date("F j, Y", strtotime($searchData->end))  }}</span>

                        @else
                        All Booking Report's
                        @endif
                        <a href="{{ route('super.carpool.reports.all') }}"
                            class="btn btn-primary gradient-green-tea float-right">Reload <i class="fa fa-refresh"
                                aria-hidden="true"></i></a>

                        <button id="SearchByModal"
                            class="btn btn-success gradient-sublime-vivid  float-right mr-1">Search <i
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('super.carpool.report.search') }}" id="ModalForm" method="post">
                    @csrf
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class='input-group'>
                                    <input type='text' class="form-control" id="datepicker2" name="end"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <select name="car_id" class="form-control">
                                    ...
                                    <option value="{{ $car->id }}">
                                        {{ $car->name .' || '. $car->number .' || '. $car->driverName}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
