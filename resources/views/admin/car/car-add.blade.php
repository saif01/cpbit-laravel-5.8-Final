    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-colored-controls">Car Add</h4>

            </div>
            <div class="card-body">

                <form action="{{ route('car.add.action') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="capacity" placeholder="Enter Car Capacity in Person"
                                    required="required">
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <div class="custom-control custom-radio d-inline-block ml-1">
                                    <input type="radio" id="temporaryN" value="0" name="temporary" class="custom-control-input" checked>
                                    <label class="custom-control-label" for="temporaryN">Regular</label>
                                </div>
                                <div class="custom-control custom-radio d-inline-block ml-2">
                                    <input type="radio" id="temporaryY" value="1" name="temporary" class="custom-control-input">
                                    <label class="custom-control-label" for="temporaryY">Temporary</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            <label class="label-control" for="timesheetinput7">Car Remarks </label>
                                <textarea id="timesheetinput7" class="form-control" placeholder="Enter Car Remarks" name="remarks"></textarea>
                        </div>
                    </div>
