    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-colored-controls">Driver Edit</h4>

            </div>
            <div class="card-body">

                <form action="{{ route('driver.update.action', $data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="name" class="form-control" id="checkValue"
                                                placeholder="Enter Driver Name" value="{{ $data->name }}" required="required">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <select name="car_id" class="form-control" >
                                                <option value="{{ $data->carId }}">{{ $data->carName .' || '. $data->number }}</option>
                                                @foreach ($carData as $car)
                                                <option value="{{ $car->id }}">{{ $car->name .' || '. $car->number }}
                                                </option>
                                                @endforeach
                                            </select>
                                        </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="number" name="contact" class="form-control"
                                                placeholder="Enter Driver Phone Number" value="{{ $data->contact }}" required="required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="nid" class="form-control"
                                                placeholder="Enter Driver NID" value="{{ $data->nid }}" required="required" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            <input type="text" name="license" class="form-control"
                                                placeholder="Enter Driver License" value="{{ $data->license }}" required="required" />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                        ...
                        <div class="col-md-2">
                            <img id="preview" src="{{ asset($data->image) }}" alt="Image Not Selected" width="160" height="200" />
                        </div>
