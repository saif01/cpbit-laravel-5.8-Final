    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title" id="bordered-layout-colored-controls">Car Edit</h4>
            </div>
            <div class="card-body">

                <form action="{{ route('car.update.action',$data->id) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="number" class="form-control" id="checkValue"
                                    placeholder="Enter Car Number" value="{{ $data->number }}" readonly>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="name" value="{{ $data->name }}" placeholder="Enter Car name"
                                    required="required">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" name="capacity"
                                    placeholder="Enter Car Capacity in Person" value="{{ $data->capacity }}" required="required">
                            </div>
                        </div>
                            ...
                            <div class="input-group">
                                <div class="custom-control custom-radio d-inline-block ml-1">
                                    <input type="radio" id="temporaryN" value="0" name="temporary"
                                        class="custom-control-input" @if ($data->temporary == 0)
                                    checked
                                @endif >
                                    <label class="custom-control-label" for="temporaryN">Regular</label>
                                </div>
                                <div class="custom-control custom-radio d-inline-block ml-2">
                                    <input type="radio" id="temporaryY" value="1" name="temporary"
                                        class="custom-control-input"@if ($data->temporary == 1)
                                    checked
                                @endif >
                                    <label class="custom-control-label" for="temporaryY">Remporary</label>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <textarea id="timesheetinput7" class="form-control" placeholder="Enter Car Remarks"
                    ...
                    <div class="row">
                        <div class="col-md-4 carImgPreview">
                            <img id="preview11" src="{{ asset($data->image) }}" alt="Image Not Selected" class="rounded mx-auto d-block" width="200"
                                height="100" />
                        </div>
                        <div class="col-md-4 carImgPreview">
                            <img id="preview22" src="{{ asset($data->image2) }}" alt="Image Not Selected" class="rounded mx-auto d-block" width="200"
                                height="100" />
                        </div>
                        <div class="col-md-4 carImgPreview">
                            <img id="preview33" src="{{ asset($data->image3) }}" alt="Image Not Selected" class="rounded mx-auto d-block" width="200"
                                height="100" />
                        </div>
                    </div>
