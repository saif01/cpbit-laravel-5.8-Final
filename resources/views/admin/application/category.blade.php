...
<script>
    $(function() {
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#modalForm').prop('action', '{{ route("app.category.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#id').val(id);
            $('.inputField').val(data);
            $('#modalForm').prop('action', '{{ route("app.category.update.action") }}');
            $('#dataModal').modal('show');
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Application Category Name
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('app.category.delete',[$row->id]) }}" id="delete"
