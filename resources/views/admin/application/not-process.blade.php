        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All <b>Processing</b> Complains Reports</h4>
                        ...
                        <table class="table table-striped table-bordered alt-pagination text-center">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td> <a href="javascript:void(0);" class="viewUserData" id="{{ $row->user_id }}"
                                        title="View User Details">{{ $row->name }} </a></td>
                                    <td>{{ $row->department }} </td>
                                  <td>
                                    <a href="{{ route('app.complain.action', $row->id) }}" title="Action"> <span class="btn gradient-amber-amber white"><i class="fa fa-edit text-success"></i> Action</span> </a>
                                </td>
