...
<script>
    $(function() {
        ...
        $('#dataAddByModal').click(function() {
            ...
            $('#modalForm').prop('action', '{{ route("app.subcategory.add.action") }}');
         ...
         $(".editByModal").click(function(){
            ...
            $('#modalForm').prop('action', '{{ route("app.subcategory.update.action") }}');
            $('#dataModal').modal('show');
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Application SubCategory Name
                            ...
                            <tbody>
                                ...
                                <tr class="text-center">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('app.subcategory.delete',[$row->id]) }}" id="delete"
