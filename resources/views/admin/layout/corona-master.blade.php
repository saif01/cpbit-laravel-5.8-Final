    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('admin/app-assets/img/sidebar-bg/01.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('corona.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h4">iTemp</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('corona.dashboard') }}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <li class="nav-item"><a href="{{ route('corona.user.dashboard') }}"><i class="ft-user green"></i><span data-i18n="" class="menu-title">All iTemp User</span>
                            </a>
                        </li>


                        <li class="nav-item"><a href="{{ route('admin.corona.checkpoint') }}"><i class="ft-layers yellow"></i><span data-i18n=""
                            class="menu-title">Check Points</span>
                            </a>
                        </li>
                        ...
                        <li class="has-sub nav-item"><a href="#"><i class="icon-paper-clip indigo"></i><span data-i18n=""
                            class="menu-title">Report Section</span></a>
                            <ul class="menu-content">

                                <li class="nav-item"><a href="{{ route('admin.user.temp.reports') }}"><i class="icon-layers yellow"></i><span data-i18n=""
                                            class="menu-title">Users Report</span></a>
                                </li>

                                <li class="nav-item"><a href="{{ route('admin.others.temp.reports') }}"><i class="icon-layers yellow"></i><span data-i18n=""
                                    class="menu-title">Others Report</span></a>
                                </li>
