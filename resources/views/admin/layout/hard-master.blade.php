...
<body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel"
            data-image="{{ asset('admin/app-assets/img/sidebar-bg/hard.jpg') }}" class="app-sidebar">
            <!-- main menu header-->
            <!-- Sidebar Header starts-->
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('hard.admin.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}"
                                class="rotate logoImg" /></div><span class="text align-middle h5">Hardware</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true"
                        ...
                        <li class="nav-item"><a href="{{ route('hard.admin.dashboard') }}"><i class="ft-home"></i><span
                                    data-i18n="" class="menu-title">Dashboard</span></a></li>

                    <li class="nav-item"><a href="{{ route('hard.notprocess.complain') }}"><i class="icon-pin red"></i><span data-i18n="" class="menu-title">Not
                                Process</span> <span class="badge gradient-ibiza-sunset white ml-3">{{ $Object->NotProcessCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('hard.processing.complain') }}"><i class="icon-hourglass amber"></i><span data-i18n=""
                                class="menu-title">Processing</span> <span
                                class="badge gradient-amber-amber white ml-3">{{ $Object->ProcessingCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('hard.closed.complain') }}"><i class="icon-briefcase success"></i><span data-i18n=""
                                class="menu-title">Closed</span> <span
                                class="badge gradient-green-tea white ml-4">{{ $Object->ClosedCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('hard.canceled.complain') }}"><i class="icon-briefcase danger"></i><span
                                data-i18n="" class="menu-title">Canceled</span> <span
                                class="badge gradient-ibiza-sunset white ml-4">{{ $Object->CanceledCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('hard.damaged.complain') }}"><i class="ft-alert-octagon red"></i><span data-i18n="" class="menu-title">Damaged
                            </span></a>
                    </li>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="icon-paper-clip indigo"></i><span data-i18n=""
                                class="menu-title">Delivery Section</span></a>
                        <ul class="menu-content">

                            <li class="nav-item"><a href="{{ route('hard.complain.report.deliverable') }}"><i class="icon-layers yellow"></i><span data-i18n=""
                                        class="menu-title">Deliverable</span></a>
                            </li>
                            <li class="nav-item"><a href="{{ route('hard.complain.report.delivered') }}"><i class="icon-share-alt blue"></i><span data-i18n=""
                                        class="menu-title">Delivered</span></a>
                            </li>
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">Hardware
                                Section</span></a>
                        <ul class="menu-content">
                            <li class="nav-item"><a href="{{ route('all.hard.category') }}"><i class="icon-note yellow"></i><span data-i18n=""
                                        class="menu-title">Category</span></a>
                            </li>
                            <li class="nav-item"><a href="{{ route('all.hard.subcategory') }}"><i class="icon-note blue"></i><span data-i18n=""
                                        class="menu-title">Subcategory</span></a>
                            </li>

                        </ul>
                    </li>

                    <li class="nav-item"><a href="{{ route('hard.complain.report.all') }}"><i class="fa fa-clone yellow"></i><span data-i18n="" class="menu-title">Report
                                All</span></a>
                    </li>

                        <li class="nav-item">
                            <a href="{{ route('admin.logout') }}"><i class="ft-log-out red"></i><span data-i18n=""
                ...
                <div class="navbar-container">
                    <div id="navbarSupportedContent" class="collapse navbar-collapse">
                        <a href="{{ route('admin.dashboard') }}"><button
                                class="btn btn-raised gradient-pomegranate white big-shadow mr-3">Home</button></a>
                        <ul class="navbar-nav">
