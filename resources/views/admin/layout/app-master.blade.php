...
<body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel"
            data-image="{{ asset('admin/app-assets/img/sidebar-bg/app.jpg') }}" class="app-sidebar">
            <!-- main menu header-->
            <!-- Sidebar Header starts-->
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('app.admin.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}"
                                class="rotate logoImg" /></div><span class="text align-middle h5">Application</span>
                    </a>
           ...
           @php
            ...
            $Object = new ApplicationController();
           @endphp
            <!-- main menu content-->
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true"
                        ...
                        <li class="nav-item"><a href="{{ route('app.admin.dashboard') }}"><i class="ft-home"></i><span
                                    data-i18n="" class="menu-title">Dashboard</span></a></li>

                    <li class="nav-item"><a href="{{ route('app.notprocess.complain') }}"><i class="icon-pin red"></i><span data-i18n="" class="menu-title">Not
                                Process</span> <span class="badge gradient-ibiza-sunset white ml-3">{{ $Object->NotProcessCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('app.processing.complain') }}"><i class="icon-hourglass amber"></i><span data-i18n=""
                                class="menu-title">Processing</span> <span
                                class="badge gradient-amber-amber white ml-3">{{ $Object->ProcessingCount() }}</span>
                        </a>
                    </li>

                    <li class="nav-item"><a href="{{ route('app.closed.complain') }}"><i class="icon-briefcase success"></i><span data-i18n=""
                    ...
                    <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">Application
                                Section</span></a>
                        <ul class="menu-content">
                            <li class="nav-item"><a href="{{ route('all.app.category') }}"><i class="icon-note yellow"></i><span data-i18n=""
                                        class="menu-title">Category</span></a>
                            </li>
                            <li class="nav-item"><a href="{{ route('all.app.subcategory') }}"><i class="icon-note blue"></i><span data-i18n=""
                    ...
                    <li class="nav-item"><a href="{{ route('app.complain.report.all') }}"><i class="fa fa-clone yellow"></i><span data-i18n="" class="menu-title">Report
                                All</span></a>
                    </li>
