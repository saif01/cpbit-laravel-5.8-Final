    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('admin/app-assets/img/sidebar-bg/car.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('network.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle">Network</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('network.dashboard') }}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <li class="nav-item"><a href="{{ route('main.ip.all') }}"><i class="ft-calendar red"></i><span data-i18n="" class="menu-title">Main IP</span>
                            </a>
                        </li>

                        <li class="nav-item"><a href="{{ route('sub.ip.all') }}"><i class="ft-calendar red"></i><span data-i18n="" class="menu-title">Sub IP</span>
                        </a>
                        </li>

                        <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">IP Group List</span></a>
                            <ul class="menu-content">
                                @php
                                    use App\Http\Controllers\Network\NetworkGroupController;
                                    $Object = new NetworkGroupController();
                                    $groupNames = $Object->GroupNameList();
                                @endphp

                                @foreach ($groupNames as $item)
                            <li class="nav-item"><a href="{{ route('group.ip.list',[$item->name]) }}"><i class="ft-layers yellow"></i><span data-i18n="" class="menu-title">{{ $item->name }}</span></a>
                                    </li>
                                @endforeach
                        ...
                        <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">Report
                                    Section</span></a>
                            <ul class="menu-content">
                                <li class="nav-item"><a href="{{ route('report.main.ip') }}"><i class="ft-layers yellow"></i><span data-i18n="" class="menu-title">Main IP Report</span></a>
                                </li>
                        ...
                        <li class="nav-item">
                            <a href="{{ route('network.group.all') }}">
                                <i class="fa fa-clone blue"></i><span data-i18n="" class="menu-title">All Group Name</span>
                            </a>
                        </li>
