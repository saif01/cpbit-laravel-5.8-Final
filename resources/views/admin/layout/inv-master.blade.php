...
<body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('admin/app-assets/img/sidebar-bg/inv.jpg') }}" class="app-sidebar">
            <!-- main menu header-->
            <!-- Sidebar Header starts-->
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('inv.admin.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h4">Inventory</span>
                    </a>
            ...
            $Object = new InventoryController();
            $operationNames = $Object->OperationList();
            @endphp
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">

                        <li class="nav-item"><a href="{{ route('inv.admin.dashboard') }}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <li class="nav-item"><a href="{{ route('inv.add.old') }}"><i class="ft-edit yellow"></i><span data-i18n=""
                                    class="menu-title">Add Old</span>
                            </a>
                        </li>
                        <li class="nav-item"><a href="{{ route('inv.add.new') }}"><i class="ft-edit-3 green"></i><span data-i18n="" class="menu-title">Add New</span>
                            </a>
                        </li>

                        <li class="nav-item"><a href="{{ route('inv.all.new') }}"><i class="ft-list red"></i><span data-i18n="" class="menu-title">All New</span><span class="badge gradient-amber-amber white ml-3">{{ $Object->NewProduct() }}</span>
                            </a>
                        </li>

                        <div class="dropdown-divider"></div>
                        <!-- Report Section Section -->
                        <li class="has-sub nav-item"><a href="#"><i class="fa fa-th green"></i><span data-i18n="" class="menu-title">Products
                                    Section</span></a>
                            <ul class="menu-content">
                                <li class="nav-item"><a href="{{ route('inv.all.old') }}"><i class="ft-list yellow"></i><span data-i18n="" class="menu-title">All Products</span></a>
                                </li>
                                <li class="nav-item"><a href="{{ route('inv.all.given') }}"><i class="ft-list blue"></i><span data-i18n="" class="menu-title">All Given</span></a>
                                </li>

                                <li class="nav-item"><a href="{{ route('inv.all.old.running') }}"><i class="ft-list green"></i><span data-i18n=""
                                            class="menu-title">All Running</span></a>
                                </li>

                                <li class="nav-item"><a href="{{ route('inv.all.old.damaged') }}"><i class="ft-list red"></i><span data-i18n=""
                                            class="menu-title">All Damaged</span></a>
                                </li>

                            </ul>
                        </li>

                        <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">Operation Report</span></a>
                            <ul class="menu-content">
                            
                                @foreach ($operationNames as $item)
                            <li class="nav-item"><a href="{{ route('operation.report',[$item->operation]) }}"><i class="ft-layers yellow"></i><span data-i18n="" class="menu-title">{{ $item->operation }}</span></a>
                                    </li>
                                @endforeach
                        ...
                        <li class="has-sub nav-item"><a href="#"><i class="ft-slack yellow"></i><span data-i18n="" class="menu-title">Warranty Section</span></a>
                            <ul class="menu-content">
                                <li><a href="{{ route('inv.all.warranty') }}" class="menu-item"><i class="ft-list"></i>All Warranty</a></li>
                                <li><a href="{{ route('inv.all.warranty.available') }}" class="menu-item"><i class="ft-list green"></i>Warranty Available</a></li>
                                <li><a href="{{ route('inv.all.warranty.expired') }}" class="menu-item"><i class="ft-list red"></i>Warranty
                                        Expired</a></li>
                            </ul>
                        </li>

                        <li class="nav-item"><a href="{{ route('operation.all') }}"><i class="ft-list green"></i><span data-i18n="" class="menu-title">All Operations</span>
                        </a>
                    </li>
