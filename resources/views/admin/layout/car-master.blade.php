...
<body data-col="2-columns" class=" 2-columns ">
    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('admin/app-assets/img/sidebar-bg/car.jpg') }}" class="app-sidebar">
            <!-- main menu header-->
            <!-- Sidebar Header starts-->
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('carpool.admin.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle">Carpool</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('carpool.admin.dashboard') }}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <li class="nav-item"><a href="{{ route('car.report.calendar') }}"><i class="ft-calendar red"></i><span data-i18n="" class="menu-title">Calendar View</span>
                            </a>
                        </li>

                        <!-- Report Section Section -->
                        <li class="has-sub nav-item"><a href="#"><i class="ft-link-2 green"></i><span data-i18n="" class="menu-title">Report
                                    Section</span></a>
                            <ul class="menu-content">
                                <li class="nav-item"><a href="{{ route('car.report.all') }}"><i class="ft-layers yellow"></i><span data-i18n="" class="menu-title">Report All</span></a>
                                </li>
                                <li class="nav-item"><a href="{{ route('car.maintenance.report') }}"><i class="ft-layers blue"></i><span data-i18n="" class="menu-title">Maintance Report</span></a>
                                </li>
                                <li class="nav-item"><a href="{{ route('driver.leave.report') }}"><i class="ft-layers blue"></i><span data-i18n="" class="menu-title">Leave Report</span></a>
                                </li>
                                <li class="nav-item"><a href="{{ route('car.requisition.report') }}"><i class="ft-layers blue"></i><span data-i18n="" class="menu-title">Requisition Report</span></a>
                                </li>
                        ...
                        <li class="has-sub nav-item"><a href="#"><i class="fa fa-car yellow"></i><span data-i18n="" class="menu-title">Car Section</span></a>
                            <ul class="menu-content">
                                <li><a href="{{ route('car.add') }}" class="menu-item"><i class="ft-user-plus"></i>Add
                                        Car</a></li>
                                <li><a href="{{ route('car.all') }}" class="menu-item"><i class="ft-users text-success"></i>All Car</a></li>
                            </ul>
                        </li>

                        <li class="has-sub nav-item"><a href="#"><i class="ft-chrome light-green"></i><span data-i18n="" class="menu-title">Driver
                                    Section</span></a>
                            <ul class="menu-content">
                                <li><a href="{{ route('driver.add') }}" class="menu-item"><i class="ft-user-plus"></i>Add
                                        Driver</a></li>
                                <li><a href="{{ route('driver.all') }}" class="menu-item"><i class="ft-users text-success"></i>All Driver</a></li>
                            </ul>
                        </li>

                        <li class="nav-item">
                            <a href="{{ route('car.destination.all') }}">
