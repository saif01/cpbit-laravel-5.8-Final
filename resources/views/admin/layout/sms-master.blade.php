    ...
    <div class="wrapper">
        ...
        <div data-active-color="white" data-background-color="man-of-steel" data-image="{{ asset('admin/app-assets/img/sidebar-bg/car.jpg') }}" class="app-sidebar">
            ...
            <div class="sidebar-header">
                <div class="logo clearfix"><a href="{{ route('sms.admin.dashboard') }}" class="logo-text float-left">
                        <div class="logo-img"><img src="{{ asset('common/logo/cpbit.png') }}" class="rotate logoImg" /></div><span class="text align-middle h5">IT-Connect</span>
                    </a>
            ...
            <div class="sidebar-content">
                <div class="nav-container">
                    <ul id="main-menu-navigation" data-menu="menu-navigation" data-scroll-to-active="true" class="navigation navigation-main">
                        ...
                        <li class="nav-item"><a href="{{ route('sms.admin.dashboard') }}"><i class="ft-home"></i><span data-i18n="" class="menu-title">Dashboard</span></a></li>

                        <div class="dropdown-divider"></div>
                        <li class="nav-item"><a href="{{ route('sms.admin.operation.all') }}"><i class="fa fa-th-list yellow"></i><span data-i18n="" class="menu-title">All Operations</span>
                            </a>
                        </li>

                        <li class="nav-item"><a href="{{ route('sms.admin.report.generate') }}"><i class="fa fa-comments-o green"></i><span data-i18n="" class="menu-title">SMS Reports</span>
                        </a>
                        </li>
