        ...
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="section-title  text-center">
                    ...
                    <img src="{{ asset($data->driverImage) }}" class="img-responsive driverImg"
                        alt="Driver Image" />
                ...
                @if ($drverLeave)
                <span class="bg-warning pl-1 pr-1 h6">Driver Leave : {{ date("M j, Y", strtotime($drverLeave->start))  }} To
                    {{ date("M j, Y", strtotime($drverLeave->end))  }}</span>

                {{-- Car Maintence Status Check--}}
                @elseif($carMaintance)
                <span class="bg-info pl-1 pr-1 h6">Maintenance : {{ date("M j, Y", strtotime($carMaintance->start))  }}
                    To{{ date("M j, Y", strtotime($carMaintance->end)) }}</span>

                {{-- Car Requisition Status Check--}}
                @elseif($carRequisition)
                <span class="bg-primary pl-1 pr-1 h6">Requisition : {{ date("M j, Y", strtotime($carRequisition->start)) }} To
            ...
            <div class="col-lg-6 col-md-12 m-auto">
                <div class="login-page-content">
                    <div class="login-form">
                        ...
                        <form action="{{ route('regular.car.booking.action',[$data->carId, $data->number, $data->driverId, $data->driverName, $data->contact]) }}" method="POST"  >
                            @csrf
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <label>Return DATE:
                                        <input type="text" name="end" id="datepicker2" class="form-control" placeholder="Return Date" required="required" />
                                    </label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3">
                                    <div class="pickup-location book-item">
                                        ...
                                        <select name="endTime" class="form-control" required="required">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label>Purpose:</label>
                                        <input type="text" name="purpose" class="form-control" placeholder="Type Your Booking Purpose" required="required" />
                                </div>
                            </div>

                            <div class="log-btn">
                                <button id="btnSubmit" type="submit" name="submit" class="fa fa-check-square"> BookCar</button>
                            </div>
                        </form>
                    </div>
