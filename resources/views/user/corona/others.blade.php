            ...
            <div class="card">
                ...
                <div class="card-header">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            @if (empty($search))
                            <button type="button" id="add_record" class="btn btn-success float-right">Add <i class="fa fa-pencil-square-o"></i></button>
                            @endif
...
{{-- <!--Search Modal --> --}}
@include('user.corona.modal-others-search')
{{-- Others user data add --}}
@include('user.corona.modal-add-other')
