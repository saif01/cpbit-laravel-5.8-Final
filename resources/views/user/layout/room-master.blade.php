...
<head>
    ...
    <!--=== Main Style CSS ===-->
    <link href="{{ asset('user/assets/css/main-room.min.css') }}" rel="stylesheet">
    ...
    <div class="preloader">
        <div class="preloader-spinner">
            <div class="loader-content">
                <img src="{{ asset('user/assets/img/preloader/room.gif') }}" alt="Syful-IT">
            </div>
        </div>
    </div>
    <!--== Preloader Area End ==-->
...
$topBarData = $topObject->TopbarData('room');
@endphp
    <!--== Header Area Start ==-->
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 d-none d-xl-block">
                        <nav class="mainmenu alignright">
                            <ul>
                                <li class="active"><a href="{{ route('user.room.dashboard') }}">Home </a>
                                </li>
                                ...
                                <li>
                                    <a href="#">
                                        <img src="{{ asset(Session::get('user.image')) }}" class="img-responsive r_user"
                                            alt="Image" /> </a>
                                    <ul>
                                        <li><a href="{{ route('user.booked.room') }}">My Booked Room</a></li>
                                        <li><a href="{{ route('user.canceled.booked.room') }}">My Canceled Room</a></li>
                                        <li><a href="{{ route('room.user.profile') }}">My Profile</a></li>
                                        <li><a href="{{ route('user.room.booking.history') }}">My Booking History</a></li>
                                ...
                                <li><a href="#"> Room List </a>
                                    <ul>
                                        <li><a href="{{ route('user.meeting.room.list') }}">Meeting Room</a></li>
                                        <li><a href="#">Residential Room</a></li>
                                    </ul>
                                </li>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-12 text-center">
                        <p>Copyright &copy; C.P.Bangladesh Room Management Powered by CPB-IT.</p>
                    </div>
                </div>
            </div>
        </div>
