@extends('user.layout.it-connect-master')
{{-- Page CSS --}}
@section('page-css')
{{-- Data table css --}}
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Sale Payment Reports
                        <a href="{{ route('user.it.connect.export.excel.sale.payment',[ 'date'=>$date, 'opCode'=>$opCode, 'operationName'=>$operationName]) }}">
