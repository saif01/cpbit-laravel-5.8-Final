...
class BuLocationController extends Controller
{
    public function All()
    {
        $allData = BuLocation::orderBy('id', 'desc')->get();
        //print_r($allData);
        return view('admin.super.bulocation')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if ($successData) {
            ...
            return Redirect()->route('bulocation.all')->with($notification);
        } else {
            $notification = array(
                'title' => 'Error',
