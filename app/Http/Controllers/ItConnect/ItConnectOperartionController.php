...
class ItConnectOperartionController extends Controller
{
    public function All()
    {
        $allData = ItConnectOperation::orderBy('id', 'desc')->get();
        //print_r($allData);
        return view('admin.it-connect.operation-code')->with('allData', $allData);
    }
    ...
    public function Insert(Request $request)
    {
        ...
        if ($successData) {
            ...
            return Redirect()->route('it.connect.admin.operation.all')->with($notification);
        } else {
            $notification = array(
                'title' => 'Error',
    ...
    {
        $data = ItConnectOperation::find($id);
